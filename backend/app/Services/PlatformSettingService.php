    ...
    public function definitions(): array
    {
        return [
            ...
            'organization_trial_days' => [
                'group' => 'commercial',
                'label' => 'Organization trial duration',
                'description' => 'Default evaluation period granted when a demo request becomes an organization.',
                'type' => 'integer',
                'default' => 14,
            ...
            'organization_grace_days' => [
                'group' => 'commercial',
                'label' => 'Commercial grace period',
                'description' => 'Read-only transition period before operational access is suspended.',
                'type' => 'integer',
                'default' => 7,
            ...
            'trial_employee_limit' => [
                'group' => 'commercial',
                'label' => 'Trial employee limit',
                'description' => 'Maximum active or invited operators and technicians. Administrators are excluded.',
                'type' => 'integer',
                'default' => 4,
            ...
            'trial_operator_limit' => [
                'group' => 'commercial',
                'label' => 'Trial operator limit',
                'description' => 'Maximum active or invited operator accounts during an organization trial.',
                'type' => 'integer',
                'default' => 2,
            ...
            'trial_technician_limit' => [
                'group' => 'commercial',
                'label' => 'Trial technician limit',
                'description' => 'Maximum active or invited technician accounts during an organization trial.',
                'type' => 'integer',
                'default' => 2,
                'rules' => ['required', 'integer', 'min:1', 'max:25'],
                'unit' => 'technicians',
            ...
            'trial_station_limit' => [
                'group' => 'commercial',
                'label' => 'Trial station limit',
                'description' => 'Maximum charging stations that can be onboarded during an organization trial.',
                'type' => 'integer',
                'default' => 5,
