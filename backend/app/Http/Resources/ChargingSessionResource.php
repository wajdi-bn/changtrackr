...
class ChargingSessionResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'idle_started_at' => $this->idle_started_at?->toISOString(),
            'idle_seconds' => $this->idle_seconds,
            'idle_grace_seconds' => $this->idle_grace_seconds,
            'idle_minutes' => (int) ceil(max(0, $this->idle_seconds - $this->idle_grace_seconds) / 60),
            ...
            'idle_fee_millimes' => $this->idle_fee_millimes,
            ...
            'minimum_adjustment_millimes' => max(0, $this->minimum_charge_millimes - (((int) round($this->energy_kwh * $this->price_per_kwh_millimes) - $this->discount_millimes) + $this->session_fee_millimes + $this->idle_fee_millimes)),
