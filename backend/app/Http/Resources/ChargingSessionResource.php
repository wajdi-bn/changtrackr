...
class ChargingSessionResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'energy_cost_millimes' => (int) round($this->energy_kwh * $this->price_per_kwh_millimes),
            'minimum_adjustment_millimes' => max(0, $this->minimum_charge_millimes - ((int) round($this->energy_kwh * $this->price_per_kwh_millimes) + $this->session_fee_millimes)),
