...
class DemoDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $users = [
            ...
            ['name' => 'Sami Ben Amor', 'email' => 'admin@chargetrackr.local', 'role' => 'admin', 'organization_id' => $organization->id, 'phone' => '+216 20 200 200', 'team' => 'Management', 'address' => 'Les Berges du Lac, Tunis', 'avatar_url' => '/assets/avatars/admin-sami-ben-amor.webp'],
