...
use App\Http\Middleware\EnsureOrganizationCommercialAccess;
...
Route::middleware(['auth:sanctum', EnsureUserOrganizationScope::class, EnsureOrganizationCommercialAccess::class])->group(function (): void {
    ...
    Route::patch('/commercial/plans/{saasPlan}', [OrganizationCommercialController::class, 'updatePlan']);
    Route::get('/commercial/portfolio', [OrganizationCommercialController::class, 'portfolio']);
    Route::post('/commercial/subscriptions/{subscription}/extend-trial', [OrganizationCommercialController::class, 'extendTrial']);
    Route::post('/commercial/subscriptions/{subscription}/suspend', [OrganizationCommercialController::class, 'suspend']);
    Route::post('/commercial/subscriptions/{subscription}/restore', [OrganizationCommercialController::class, 'restore']);
    Route::post('/commercial/invoices/{invoice}/settle', [OrganizationCommercialController::class, 'settle']);
    Route::post('/commercial/invoices/{invoice}/void', [OrganizationCommercialController::class, 'void']);
    Route::get('/commercial/invoices/{invoice}/document', [OrganizationCommercialController::class, 'invoiceDocument']);
    Route::get('/organization-billing', [OrganizationCommercialController::class, 'organizationBilling']);
    Route::post('/organization-billing/requests', [OrganizationCommercialController::class, 'requestPlan']);
