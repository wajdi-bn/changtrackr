...
Intégration API & Vérifier validation, persistance, autorisation, événements et isolation multi-tenant. & Laravel Test, SQLite en mémoire et PostgreSQL en CI \\ \hline
...
Qualité frontend & Détecter les erreurs TypeScript, les régressions de contrats UI et les imports invalides. & Node Test Runner, Oxlint, TypeScript, Vite \\ \hline
...
Infrastructure et livraison & Vérifier les images, secrets, réseaux privés, TLS, configuration Docker et politique CI/CD. & Node Test Runner, Docker Compose, GitHub Actions \\ \hline
Non fonctionnel & Mesurer performance, sécurité, résilience et compatibilité. & Campagne manuelle et outils de charge à compléter \\ \hline
\end{tabularx}
\end{table}
