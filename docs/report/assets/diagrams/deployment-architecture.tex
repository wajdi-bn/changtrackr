\begin{tikzpicture}[
  ...
  \node[optional] (redis) at (5.0,-4.2) {Redis optionnel\\\texttt{:6379}};
  \node[optional] (mailpit) at (10.0,-4.2) {Mailpit optionnel\\\texttt{:8025/1025}};
  \node[container] (gateway) at (0,-6.8) {Gateway OCPP\\\texttt{:9000}};
  \node[container] (sap) at (5.0,-6.8) {Simulateur SAP\\\texttt{:8082}};
  \node[container] (wiremock) at (10.0,-6.8) {WireMock\\\texttt{:9090}};
  ...
  \draw[dashed, flow] (laravel) -- (redis);
  ...
  \node[zone, fit=(postgres)(redis)(mailpit)(gateway)(sap)(wiremock),
