...
\section{Du prototype à l'interface réalisée}

Le prototype a joué le rôle de contrat visuel avant l'implémentation. Il a fixé
une identité claire, une navigation latérale compacte, une barre supérieure
stable, des bandeaux de contexte et des espaces de travail denses mais lisibles.
La figure~\ref{fig:interfaces-prototype-public} rassemble la direction retenue
pour l'entrée publique et les principales vues métier envisagées.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\textwidth]{assets/screenshots/prototype-landing.png}
  \caption{Prototype de référence de ChargeTrackr}
  \label{fig:interfaces-prototype-public}
\end{figure}

L'application réalisée ne reproduit pas ces maquettes comme des images
statiques. Les composants Ant Design ont été adaptés au système visuel du
prototype, puis reliés aux autorisations, aux états de chargement, aux erreurs,
aux filtres et aux données renvoyées par l'API. Les mêmes repères sont conservés
sur l'ensemble du produit, mais le contenu et les actions diffèrent selon le
rôle.
