...
le contrat fonctionnel, le déroulement nominal et les exceptions. Deux emplacements
UML sont réservés à la suite de chaque fiche : un diagramme de cas d'utilisation
raffiné et un diagramme de séquence système. Leur contenu sera produit à partir des
scénarios validés, sans introduire d'opération absente du Product Backlog.

\newcommand{\UseCaseUmlPlate}[1]{%
  \begin{figure}[p]
    \centering
    \begin{tcolorbox}[
      width=0.94\textwidth,
    ...
    \begin{tcolorbox}[
      ...
      {\large\bfseries\color{ctdark}Diagramme de séquence système}\\[2mm]
      {\color{ctgray}Emplacement réservé pour #1}\\[1mm]
      {\small Acteur principal, plateforme, systèmes externes, alternatives et
...
\UseCaseUmlPlate{UC-01 -- Demande de démonstration et provisionnement}
...
\UseCaseUmlPlate{UC-02 -- Invitation et activation d'un employé}
...
\UseCaseUmlPlate{UC-03 -- Mise en service d'une station OCPP}
...
\UseCaseUmlPlate{UC-04 -- Calcul de la disponibilité}
...
\UseCaseUmlPlate{UC-05 -- Recharge et paiement}
...
\UseCaseUmlPlate{UC-06 -- Traitement d'une alerte et d'une intervention}
...
\UseCaseUmlPlate{UC-07 -- Cycle commercial d'une organisation}
...
\UseCaseUmlPlate{UC-08 -- Génération et échange d'un rapport}
