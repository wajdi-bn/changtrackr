...
production. TLS public, les contrôles de secrets en CI, les en-têtes de sécurité
et les sauvegardes planifiées sont désormais intégrés. Il reste notamment à
automatiser un scan continu des dépendances, formaliser la rotation des secrets,
centraliser les métriques et journaux, exécuter des tests de charge OCPP et
réaliser périodiquement un exercice de restauration.
