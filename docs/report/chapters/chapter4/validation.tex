...
La compilation frontend signale plusieurs bundles supérieurs à 500~kio ; le
principal fichier JavaScript atteint environ 767~kio. Ce constat conduit à
planifier le découpage par route, le chargement différé de PDF.js et du scanner
QR, la séparation des bibliothèques d'icônes et de graphiques, puis une mesure
Lighthouse sur réseau mobile.
