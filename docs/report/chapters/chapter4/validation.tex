...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|p{3.2cm}|Y|}
    ...
    chargés par PHPUnit.\\\hline
    \texttt{pnpm test:ocpp-tools} &
    2 tests, 0 échec & Lecture et contrôle des états du simulateur.\\\hline
    \texttt{pnpm lint:frontend} &
    Succès & Analyse Oxlint du code TypeScript/React.\\\hline
    \texttt{pnpm build:frontend} &
    Succès & Type-check TypeScript et bundle Vite de production.\\\hline
    Inventaire des routes &
    186 routes, dont 177 API & 75 GET, 67 POST, 23 PATCH/PUT et 12 DELETE.\\\hline
...
\begin{longtable}{|C{1.5cm}|p{3.3cm}|p{4.5cm}|p{4.0cm}|}
  ...
  Compilation, contrôles transversaux et validation des documents.\\
  \hline
\end{longtable}
