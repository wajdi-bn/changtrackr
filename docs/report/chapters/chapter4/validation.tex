...
La campagne exécutée le 29 juillet 2026 produit les résultats suivants :
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|p{4.5cm}|p{3.2cm}|Y|}
    ...
    203 tests, 1\,980 assertions & Tests Feature et unitaires chargés par
    PHPUnit.\\\hline
    \texttt{python -m pytest} dans \texttt{ocpp-gateway} &
    12 tests, 0 échec & Messages entrants, commandes distantes, signatures et
...
\begin{longtable}{|p{3.0cm}|p{4.5cm}|p{6.8cm}|}
  ...
  Cache, sessions et queue sur PostgreSQL pour limiter les services du MVP.
  Redis reste une option de montée en charge, mais n'est pas requis par
  l'environnement livré.\\\hline
...
commandes d'exploitation des simulateurs et le présent rapport. Scramble génère
