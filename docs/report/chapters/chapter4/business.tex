...
\subsection{INC-04 : exploitation terrain}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{assets/screenshots/alerts-workspace.png}
...
\subsection{INC-05 : recharge, transaction et paiement}
...
\subsection{INC-06 : tarification et commerce}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{assets/screenshots/organization-billing.png}
  \caption{Suivi de l'abonnement commercial d'une organisation}
  \label{fig:implementation-organization-billing}
\end{figure}
...
\subsection{INC-07 : pilotage, reporting et gouvernance}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{assets/screenshots/admin-overview.png}
  \caption{Tableau de bord réel de l'administrateur}
  \label{fig:implementation-admin-dashboard}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{assets/screenshots/administrator-reports.png}
  \caption{Studio de performance de l'administrateur}
  \label{fig:implementation-admin-reports}
\end{figure}
...
\subsection{INC-08 : exports et évolutions différées}
...
retour arrière et une validation sur borne. Elle reste donc une évolution de
l'INC-08, conformément au risque de 13 points associé à US-38.
