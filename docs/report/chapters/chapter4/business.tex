...
Dans l'environnement de démonstration, un terminal de borne virtuel permet au
client de simuler le geste physique de branchement sans ouvrir une session
d'administration ni accéder au Simulation Lab. Cette action produit le même
événement OCPP que celui attendu après l'insertion d'un câble sur une borne
réelle ; l'assistant passe alors automatiquement à l'étape suivante.
