...
\CompanyName{} au produit disponible le 14 août 2026. Elle ne remplace pas ce
...
\begin{longtable}{|C{2.4cm}|p{11.7cm}|}
  ...
  \covvalidate & La preuve disponible reste insuffisante pour garantir un seuil
  contractuel, une charge cible ou un comportement matériel réel.\\
  \hline
\end{longtable}
...
\begin{longtable}{|C{1.0cm}|p{3.2cm}|C{2.0cm}|p{7.9cm}|}
  ...
  Redis~7 porte la queue, le cache et les sessions. Le scheduler et les workers
  sont isolés en processus dédiés ; PostgreSQL conserve uniquement les données
  métier durables.\\\hline
...
\begin{longtable}{|C{1.0cm}|p{3.0cm}|C{2.0cm}|p{8.1cm}|}
  ...
  La plateforme est déployée publiquement, mais la disponibilité du service n'a
  pas encore été mesurée sur une durée suffisante pour garantir ce seuil.\\\hline
  N03 & HTTPS et chiffrement & \covpartial &
  Les secrets sont exclus du dépôt, condensés ou chiffrés selon leur usage.
  HTTPS et WSS sont terminés par Caddy. La rotation périodique des clés et un
  audit externe restent à formaliser.\\\hline
...
\begin{longtable}{|p{4.2cm}|C{2.0cm}|p{7.9cm}|}
  ...
  Code source & \covreal &
  Dépôt Git versionné avec frontend, backend, gateway, infrastructure locale et
  cible de production Azure.\\\hline
...
externe, une qualification de charge ou une extension fonctionnelle distincte.
