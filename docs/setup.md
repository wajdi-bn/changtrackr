...
Administrators and operators can use `Add station` in `/stations` to create a simulated station.
They choose a verified hardware profile; the application derives its connectors and provisions the
